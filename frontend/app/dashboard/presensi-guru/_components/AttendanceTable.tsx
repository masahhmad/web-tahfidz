          ...
          <tbody>
            {RECORDS.map((record) => (
              <tr key={record.no} className="border-b border-[#eff0f1] last:border-b-0">
                ...
                <td className="px-6 py-2.5 text-[14px] leading-5 text-[#404944] whitespace-nowrap">{record.time}</td>
                <td className="px-6 py-2.5 text-[14px] leading-5 text-[#404944] whitespace-nowrap">{record.location}</td>
